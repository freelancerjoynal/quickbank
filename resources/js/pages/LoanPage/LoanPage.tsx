    ...
    return (
        <WebsiteLayout>
            <div className="min-h-screen bg-gray-50">
                ...
                <div className="border-t border-b border-gray-200 bg-white py-12">
                    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                        <h2 className="mb-8 text-3xl font-semibold text-gray-800">Loan Calculator</h2>
                        <div className="rounded-lg bg-gray-50 p-6 shadow-md md:p-8">
                            <div className="grid grid-cols-1 gap-8 lg:grid-cols-12">
                                {/* Left side - Controls */}
                                <div className="lg:col-span-7">
                                    <h3 className="mb-6 text-xl font-semibold">Loan Details</h3>
                                    ...
                                    <div className="mb-6">
                                        <label htmlFor="loanTerm" className="mb-1 block text-sm font-medium text-gray-700">
                                    ...
                                    <div className="mb-6">
                                        <label htmlFor="paymentFrequency" className="mb-1 block text-sm font-medium text-gray-700">
                                            Payment Frequency
                                        </label>
                                        <select
                                            id="paymentFrequency"
                                            ...
                                            className="w-full rounded-md border border-gray-300 p-2 focus:ring-2 focus:ring-amber-500 focus:outline-none"
                                        >
                                ...
                                <div className="rounded-lg bg-white p-6 shadow-md lg:col-span-5">
                                    <h3 className="mb-6 text-xl font-semibold">Loan Summary</h3>

                                    <div className="space-y-4">
                                        <div className="mb-6 rounded-md bg-blue-50 p-4">
                                            <div className="mb-1 text-sm text-blue-800">Monthly Payment</div>
                                            <div className="text-2xl font-bold text-blue-900">{formatCurrency(calculateMonthlyPayment())}</div>
                                        </div>

                                        <div className="grid grid-cols-2 gap-4">
                                            <div>
                                                <div className="mb-1 text-sm text-gray-500">Total Principal</div>
                                                <div className="text-lg font-semibold text-gray-900">{formatCurrency(loanAmount)}</div>
                                            </div>

                                            <div>
                                                <div className="mb-1 text-sm text-gray-500">Total Interest</div>
                                        ...
                                        <div className="pt-4">
                                            <button className="w-full rounded-md bg-amber-500 px-4 py-3 font-medium text-white transition duration-300 hover:bg-amber-600">
                                                Apply for This Loan
                                            </button>
                                        </div>
                                    </div>
